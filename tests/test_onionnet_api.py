...
def test_onionnet_wrappers_and_node_map():
    ...
    on.grow_onion(df_nodes, df_edges, node_prop_cols=['lbl'], edge_prop_cols=None, drop_na=False, verbose=False)
    ...
    assert isinstance(props_all, dict) and 'decoded_layer' in props_all and 'decoded_node_id' in props_all
